      ...
      <div ref={listRef} className="flex-1 space-y-3 overflow-y-auto p-3">
        {!hasActiveFilters && child && (
          <section
            ...
            className="space-y-3 rounded-2xl border border-blue-100 bg-gradient-to-b from-blue-50/50 to-white p-3 shadow-2xs"
          >
          ...
          <>
            {inSchedule.length > 0 && (
              <section className="space-y-2">
                <div className="sticky top-0 z-10 flex items-center justify-between rounded-lg bg-emerald-50/90 backdrop-blur px-2.5 py-1.5 border border-emerald-100 shadow-2xs">
                  ...
                  return (
                    <div key={group.key} className="space-y-1.5">
                      ...
                      >
                        ...
                        <span className="text-slate-500 font-semibold">({group.items.length})</span>
                      </button>
                      {!rootCollapsed && (
